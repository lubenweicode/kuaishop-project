...
public class SecurityUtilsTest {
    ...
    public SecurityUtilsTest(@Autowired JwtUtil jwtUtil) {
    ...
    public void testJwtUtil() {
        ...
        assertFalse(token.isEmpty(), "Token长度必须大于0");
...
//        System.out.println("纯文本SHA256加密结果：" + encryptedPwd);
        ...
        assertEquals(32, salt.length(), "盐值应该是32位16进制字符串（对应16字节）");
        ...
        assertEquals(64, encryptedPwdWithSalt.length(), "带盐值加密结果应该是64位");
