...
import com.repository.mapper.AdminMapper;
...
public class AdminServiceImpl extends ServiceImpl<AdminMapper, User> implements AdminService {
    ...
    public AdminServiceImpl(IdentityServiceImpl identityService, AdminMapper adminMapper, OrderMapper orderMapper, DateUtil dateUtil, SeckillActivityMapper seckillActivityMapper, SeckillProductMapper seckillProductMapper) {
    ...
    public Result<ProductVO> addProducts(Long userId, ProductDTO productDTO) {
        ...
        if (!identityService.confirmIdentity(userId)) {
